...
#SNaive Method 
#Snaive used for highly seasonal data, each forcast set to equal to the last observed value
#(Same as the forecast for the previous year)
...
# for time  graph, there is some variation in in the residuals but most center around 0
# we want to stay around zero
# for the bottom left acf plot we see alternating spikes that go above the threshold 
# which is not ideal because we see correlation in the data 
# However, the histogram shows that the residuals are mostly normal
